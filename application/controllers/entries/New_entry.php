 ...
 *
 * @package		application/controller/entries/New_entry.php
 ...
 *
 */
class New_entry extends MY_Controller {
	...
	public function index ()
	{
       //variables generales.
		...
		$this->js_script[]=site_url('js');
       	$select_data = array(
       		'categoria' => $this->load->view('bodies/select_view',$this->category->selec_cat() , TRUE)
       		);
        $this->section=$this->load->view('bodies/form/registre_form',$select_data, TRUE);
       //	$this->aside.=$this->load->view('bodies/aside_new_record','', TRUE);
	...
	public function new_item()
	{
		...
		$dato= array('flag' =>$val );
		$this->load->view('bodies/notice/db_return_view', $dato, FALSE);
	}
/**
 ...
 */
	public function salve_tv()
	{
		...
		if ($resp_vid==1&&$resp_rel==1) {
			$this->load->view('bodies/notice/all_data_salve', '', FALSE);
		} else {
				$this->load->view('bodies/notice/salve_data_error', '', FALSE);
		}
	}
